...
--
-- Host: localhost    Database: inventur_db
-- ------------------------------------------------------
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_product` (`category_id`,`subcategory_id`,`name`),
...
CREATE TABLE `users` (
  ...
  `role` enum('ADMIN','MITARBEITER','IT') DEFAULT 'MITARBEITER',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-06-25 16:56:41
